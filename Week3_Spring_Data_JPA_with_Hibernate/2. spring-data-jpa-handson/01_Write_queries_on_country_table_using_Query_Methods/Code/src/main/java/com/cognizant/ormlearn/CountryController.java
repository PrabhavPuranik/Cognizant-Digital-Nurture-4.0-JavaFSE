...
public class CountryController {
    ...
    public ResponseEntity<List<Country>> findByNameContainingOrderByNameAsc(@PathVariable String name) {
        List<Country> countries = countryService.findByNameContainingOrderByNameAsc(name);
        return new ResponseEntity<>(countries, HttpStatus.OK);
    }

    @GetMapping("/starts-with/{letter}")
    public ResponseEntity<List<Country>> findByNameStartingWith(@PathVariable String letter) {
